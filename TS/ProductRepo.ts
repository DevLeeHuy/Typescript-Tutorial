...
export class ProductRepo{
    private _listProducts: Product[] = [];
    public get listProducts(): Product[] {
        return this._listProducts;
    }
    public set listProducts(value: Product[]) {
    ...
    public static getItemByID(id:string, list:Product[]):Product{
